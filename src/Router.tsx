...
const EventsOverview = lazy(
  () => import(/* webpackChunkName: 'events-overview' */ './pages/EventsOverview'),
)
...
const LeaderboardEntries = lazy(
  () => import(/* webpackChunkName: 'leaderboard-entries' */ './pages/LeaderboardEntries'),
)
const Account = lazy(() => import(/* webpackChunkName: 'account' */ './pages/Account'))
const ConfirmPassword = lazy(
  () => import(/* webpackChunkName: 'confirm-password' */ './pages/ConfirmPassword'),
)
const Verify2FA = lazy(() => import(/* webpackChunkName: 'verify-2FA' */ './pages/Verify2FA'))
const RecoverAccount = lazy(
  () => import(/* webpackChunkName: 'recover-account' */ './pages/RecoverAccount'),
)
...
const AcceptInvite = lazy(
  () => import(/* webpackChunkName: 'accept-invite' */ './pages/AcceptInvite'),
)
const Organisation = lazy(
  () => import(/* webpackChunkName: 'organisation' */ './pages/Organisation'),
)
...
const PlayerProfile = lazy(
  () => import(/* webpackChunkName: 'player-profile' */ './pages/PlayerProfile'),
)
const PlayerLeaderboardEntries = lazy(
  () =>
    import(/* webpackChunkName: 'player-leaderboard-entries' */ './pages/PlayerLeaderboardEntries'),
)
...
const PlayerAuthActivities = lazy(
  () => import(/* webpackChunkName: 'player-auth-activities' */ './pages/PlayerAuthActivities'),
)
const PlayerSaves = lazy(() => import(/* webpackChunkName: 'player-saves' */ './pages/PlayerSaves'))
const PlayerSaveContent = lazy(
  () => import(/* webpackChunkName: 'player-save-content' */ './pages/PlayerSaveContent'),
)
const NotFound = lazy(() => import(/* webpackChunkName: 'not-found' */ './pages/NotFound'))
const Feedback = lazy(() => import(/* webpackChunkName: 'feedback' */ './pages/Feedback'))
const FeedbackCategories = lazy(
  () => import(/* webpackChunkName: 'feedback-categories' */ './pages/FeedbackCategories'),
)
    ...
    <>
      {!AuthService.getToken() && (
        <div className='flex w-full flex-col'>
          <main className='w-full bg-gray-800 md:py-16 lg:py-32'>
            <Routes>
      ...
      {AuthService.getToken() && (
        <div className='flex w-full flex-col'>
          <NavBar />
          <main className='bg-gray-800 p-4 text-white md:p-8 md:pb-16 lg:pb-32'>
            <Routes>
              <Route path={routes.dashboard} element={<Dashboard />} />
              <Route path={routes.account} element={<Account />} />
              <Route path={routes.confirmPassword} element={<ConfirmPassword />} />
              {canViewPage(user, routes.organisation) && (
                <Route path={routes.organisation} element={<Organisation />} />
              )}
              {canViewPage(user, routes.billing) && (
              ...
              {activeGame && (
                <>
                  ...
                  {canViewPage(user, routes.apiKeys) && (
                  ...
                  {canViewPage(user, routes.dataExports) && (
                    <Route path={routes.dataExports} element={<DataExports />} />
                  )}
                  ...
                  {canViewPage(user, routes.integrations) && (
                    <Route path={routes.integrations} element={<Integrations />} />
                  )}
                  <Route path={routes.groups} element={<Groups />} />
                  {canViewPage(user, routes.gameProps) && (
                    <Route path={routes.gameProps} element={<GameProps />} />
                  )}
                  <Route path={routes.playerProfile} element={<PlayerProfile />} />
                  <Route
                    path={routes.playerLeaderboardEntries}
                    element={<PlayerLeaderboardEntries />}
                  />
                  ...
                  {canViewPage(user, routes.feedbackCategories) && (
                    <Route path={routes.feedbackCategories} element={<FeedbackCategories />} />
                  )}
