...
const META_GOOGLE_PLAY_GAMES_DISPLAY_NAME = 'META_GOOGLE_PLAY_GAMES_DISPLAY_NAME'
const META_GOOGLE_PLAY_GAMES_AVATAR_URL = 'META_GOOGLE_PLAY_GAMES_AVATAR_URL'
...
export const metaPropKeyMap = {
  ...
  [META_GOOGLE_PLAY_GAMES_DISPLAY_NAME]: 'GOOGLE PLAY DISPLAY NAME',
  [META_GOOGLE_PLAY_GAMES_AVATAR_URL]: 'GOOGLE PLAY AVATAR URL',
}
